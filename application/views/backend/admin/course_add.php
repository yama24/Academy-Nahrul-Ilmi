        ...
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('course_adding_form'); ?>
                    <a href="https://academy.nahrulilmi.com/file/" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm ml-1" target="_blank"><?php echo get_phrase('upload_video'); ?></a>
