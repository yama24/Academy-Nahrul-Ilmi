                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          <div class="content-box">
                              <div class="basic-group">
                                  ...
                                  <div class="form-group">
                                      <label for="phone"><span class="input-field-icon"><i class="fas fa-phone"></i></span> <?php echo get_phrase('phone'); ?>:</label>
                                      <input type="number" class="form-control" name = "phone" id="phone" placeholder="<?php echo get_phrase('phone'); ?>" value="" required>
                                  </div>
                                  <div class="form-group">
