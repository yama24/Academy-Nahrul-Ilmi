...
<section class="course-carousel-area">
    <div class="container-lg">
        <div class="row">
            <div class="col">
                <h2 class="course-carousel-title"><?php echo get_phrase('category'); ?></h2>
                    ...
                    <div class="course-box-wrap">
                        <div class="course-box">
                            <div class="course-image">
                                <img src="<?php echo base_url('uploads/thumbnails/category_thumbnails/'.$category['thumbnail']); ?>" alt="" class="img-fluids">
                            </div>
                            <div class="course-details">
                                ...
                                foreach ($sub_categories as $sub_category): ?>
                                    <a href="<?php echo site_url('home/courses?category='.$sub_category['slug']); ?>" class="instructors"><i class="fas fa-check"></i>  <?php echo $sub_category['name']; ?></a>
                                <?php endforeach; ?>
                                <br>
                            </div>
                        </div>
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/course/'.slugify($top_course['title']).'/'.$top_course['id']); ?>" class="has-popover">
                            <div class="course-box">
                                ...
                                <div class="course-image">
                                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($top_course['id']); ?>" alt=""  class="img-fluids">
                                </div>
                                <div class="course-details">
                ...
                <div class="course-carousel">
                    ...
                    <div class="course-box-wrap">
                        <a href="<?php echo site_url('home/course/'.slugify($latest_course['title']).'/'.$latest_course['id']); ?>">
                            <div class="course-box">
                                <div class="course-image">
                                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>" alt="" class="img-fluids">
                                </div>
                                <div class="course-details">
