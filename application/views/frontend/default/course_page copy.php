    ...
    <div class="course-sidebar-text-box">
      ...
      <?php else: ?>
        ...
        <?php else: ?>
          <div class="buy-btns">
              <?php if ($this->session->userdata('user_login') != 1): ?>
                <a href="https://academy.nahrulilmi.com/home/login" class="btn btn-buy-now">Masuk</a>
              <?php else: ?>
                <a href = "https://wa.me/62<?php echo $instructor_details['phone']; ?>?text=Saya Mau Daftar Materi <?php echo $course_details['title']; ?> https://academy.nahrulilmi.com/home/course/<?php echo (str_replace(' ', '-', strtolower($course_details['title']))).'/'.$course_details['id'].' atas nama '.$user_details['first_name'].' '.$user_details['last_name'].' dengan email '.$user_details['email']; ?>" class="btn btn-buy-now" id = "course_<?php echo $course_details['id']; ?>" onclick="handleBuyNow(this)" target="_blank"><?php echo "Hubungi Admin"; ?></a>
              <?php endif; ?>
              <!--untuk tombol beli-->
